# Gerenciador de Ativos e Vulnerabilidades

Aplicação de linha de comando (CLI) em Python para cadastro e gerenciamento de ativos de TI e suas respectivas vulnerabilidades de segurança. Desenvolvido como projeto de estudo do curso de Cibersegurança da Universidade Federal de Uberlândia.
...
```bash
git clone https://github.com/byuwarn/sprint1-2.git
cd sprint1-2
